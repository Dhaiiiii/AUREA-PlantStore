                ...
                <div style="display:flex; gap:14px; align-items:center; flex-wrap:wrap;">
                  ...
                  <div style="display:flex; flex-direction:column; gap:10px; min-width:180px;">
                    <div style="display:flex; align-items:center; gap:10px; justify-content:flex-end; flex-wrap:wrap;">
                      ...
                      <span style="min-width:60px; text-align:center; font-weight:700;">Qty: <?php echo $item['qty']; ?></span>
                    ...
                    <div style="text-align:right;">
                      <a class="btn btn--ghost" style="color: var(--ink); border-color: rgba(220,234,225,.95); background: rgba(255,255,255,.78)" href="cart.php?action=remove&id=<?php echo $item['product_id']; ?>">
                        Remove
                      </a>
                    </div>
                  </div>
