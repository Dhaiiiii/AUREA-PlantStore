...
// Task: Admin login system - validate credentials against database

// Check username and password against admin table
// Use prepared statement to prevent SQL injection
// Start admin session if login successful
session_start();
require 'db.php';
...
<body>
  ...
  <section class="section">
    <div class="container" style="max-width: 680px;">
      <div class="panel">
        ...
        <form method="POST" action="admin-login.php" onsubmit="return validateAdminLogin();" style="margin-top:14px; display:grid; gap:10px;">
          <input
            id="admin-username"
            name="username"
  ...
  <script>
    // Validate admin login form before submitting
